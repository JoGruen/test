...
\title{Holotomography with Probe-Retrieval using Implicit Neural Representations}

\author{Sebastian Eberle,\authormark{1} Martin Burger,\authormark{2,*} Johannes Hagemann,\authormark{2,*} Christian G. Schroer,\authormark{2,*} and Johannes Gruen\authormark{2,3}}
